...
folder_path = 'D:/R/ISSD_Donor/Insert/CXCR4'  # Replace with the actual folder path
target_sequence = 'CGTCAGTGAGGCAGATGACAGATA'
...
output_file = 'D:/R/ISSD_Donor/Insert/CXCR4/donor_insertion.csv'  # Replace with the desired output file path

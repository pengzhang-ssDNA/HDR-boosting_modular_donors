...
folder_path = 'D:/R/ISSD_Donor/Insert/EMX1'  # Replace with the actual folder path
target_sequence = 'TGCTTCGTGGCAATGCGCCACCGGTTG'
# The sequence is the terminal sequence of 5` homology arm of donor targeting EMX1.
...
output_file = 'D:/R/ISSD_Donor/Insert/EMX1/EMX1_donor_insertion.csv'  # Replace with the desired output file path

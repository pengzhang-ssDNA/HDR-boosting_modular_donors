...
folder_path = 'D:/R/ISSD_Donor/Insert/FANCF'  # Replace with the actual folder path
target_sequence = 'AGGTAGTGCTTGAGACCGCCAGAAGCTC'
...
output_file = 'D:/R/ISSD_Donor/Insert/FANCF/FANCF_donor_insertion.csv'  # Replace with the desired output file path
